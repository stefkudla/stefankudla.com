module.exports = ({ theme }) => ({
  DEFAULT: {
    css: {
      ...
      '--tw-prose-links': theme('colors.cosmic-blue-aa-text'),
      '--tw-prose-links-hover': theme('colors.cosmic-blue-aaa-text'),
      '--tw-prose-links-underline': theme('colors.cosmic-blue / 0.3'),
      ...
      '--tw-prose-invert-links': theme('colors.cosmic-blue'),
      '--tw-prose-invert-links-hover': theme('colors.cosmic-blue / 0.8'),
      '--tw-prose-invert-links-underline': theme('colors.cosmic-blue / 0.3'),
