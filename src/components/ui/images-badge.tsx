...
interface ImagesBadgeProps {
  ...
  /** Force the expanded (open) state, skipping internal hover */
  expanded?: boolean
}
...
export function ImagesBadge({
  ...
  const isHovered = expanded ?? isHoveredInternal
  ...
  return (
    <Component
      ...
      className={cn(
        'relative inline-flex cursor-pointer items-center gap-2 perspective-[1000px] transform-3d',
        className
      )}
