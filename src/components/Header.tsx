...
const Header: React.FC = () => (
  <header className="md:pt-4 container max-w-screen-lg m-auto md:px-12 lg:px-20">
    <nav
      className="hidden md:flex justify-start items-center h-full w-full mt-auto space-x-6 text-sm lg:justify-start backdrop-filter backdrop-blur-sm  bg-opacity-30"
